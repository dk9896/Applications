...
SQLpath = txtConnString.Text
If SqlConn = True Then
    Label2.Caption = "Test OK"
Else
    Label2.Caption = "Testing NG"
End If
End Sub
...
Dim rs As ADODB.Recordset
    ...
    If Action = 1 Then
        ...
        txtConnString.Text = rs("ConnString")
        txtPLC_IP = rs("PLC_IP")
...
'        rs("PrinterName1") = Trim$(txtPrinterName1)
        rs("ConnString") = Trim$(txtConnString.Text)
