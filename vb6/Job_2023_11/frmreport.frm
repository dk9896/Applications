...
Row = 2
   ...
   End If
    ...
    With VSFReport
      ...
      .TextMatrix(Row, 27) = rs("ClkResistance1Result")
      .TextMatrix(Row, 28) = rs("ClkResistance1")
      .TextMatrix(Row, 29) = rs("ClkResistance2Result")
      .TextMatrix(Row, 30) = rs("ClkResistance2")
      .TextMatrix(Row, 31) = rs("AClkResistance1Result")
      .TextMatrix(Row, 32) = rs("AClkResistance1")
      .TextMatrix(Row, 33) = rs("AClkResistance2Result")
      .TextMatrix(Row, 34) = rs("AClkResistance2")
...
With VSFReport
    ...
    .TextMatrix(0, 27) = "Resistance Clockwise"
    .TextMatrix(0, 28) = "Resistance Clockwise"
    .TextMatrix(0, 29) = "Resistance Clockwise"
    .TextMatrix(0, 30) = "Resistance Clockwise"
    .TextMatrix(1, 27) = "Resistance - 1"
    .TextMatrix(1, 28) = "Resistance - 1"
    .TextMatrix(1, 29) = "Resistance - 2"
    .TextMatrix(1, 30) = "Resistance - 2"
    .TextMatrix(2, 27) = "Status"
    .TextMatrix(2, 28) = "Value"
    .TextMatrix(2, 29) = "Status"
    .TextMatrix(2, 30) = "Value"
     
    .TextMatrix(0, 31) = "Resistance Anti-Clockwise"
    .TextMatrix(0, 32) = "Resistance Anti-Clockwise"
    .TextMatrix(0, 33) = "Resistance Anti-Clockwise"
    .TextMatrix(0, 34) = "Resistance Anti-Clockwise"
    .TextMatrix(1, 31) = "Resistance - 1"
    .TextMatrix(1, 32) = "Resistance - 1"
    .TextMatrix(1, 33) = "Resistance - 2"
    .TextMatrix(1, 34) = "Resistance - 2"
    .TextMatrix(2, 31) = "Status"
    .TextMatrix(2, 32) = "Value"
    .TextMatrix(2, 33) = "Status"
    .TextMatrix(2, 34) = "Value"
