...
Dim TempStartingString As String
    ...
    If CopyLabel = True Then
        ...
        Counter = Format(frmPrintLabel.txtCopyNo.Text, "0000")
        ...
        TempBarcode = TempPartNo & TempHardwareNo & Counter & TempDate & TempVendorId
     Else
        Counter = Format(Val(frmMonitor.txtProductionCounter), "0000")
        TempDate = Format(Now, "ddmmyy")
        TempVendorId = VendorId
        TempPartNo = PartNo
        TempHardwareNo = HardwareNo
        barcode = TempPartNo & TempHardwareNo & Counter & TempDate & TempVendorId
        TempBarcode = barcode
    End If
...
'    TempFileTextLine = Replace(TempFileTextLine, "#HW: 003#", TempHardwareNo)
    ...
    TempFileTextLine = Replace(TempFileTextLine, "#MI-7646AFRAC004430001140323100221#", TempBarcode)
    TempFileTextLine = Replace(TempFileTextLine, "#100221#", TempVendorId)
