...
Begin VB.Form frmsettings 
   ...
   Begin VB.PictureBox Picture1 
      ...
      Begin VB.Frame Frame10 
         ...
         Top             =   5400
         Width           =   5535
         Begin VB.TextBox txtResistanceOffset 
            Alignment       =   2  'Center
            Height          =   360
            Index           =   1
            Left            =   4560
         ...
         Begin VB.TextBox txtResistanceOffset 
            ...
            Width           =   855
         End
         Begin VB.TextBox txtResistance1Max 
            Alignment       =   2  'Center
            Height          =   360
            Left            =   3120
            TabIndex        =   137
            ...
            Width           =   855
         End
         Begin VB.TextBox txtResistance2Max 
            Alignment       =   2  'Center
            Height          =   360
            Left            =   3120
            TabIndex        =   136
            ...
            Width           =   855
         End
         Begin VB.TextBox txtResistance1Min 
            Alignment       =   2  'Center
            Height          =   360
            Left            =   1920
            TabIndex        =   133
            ...
            Width           =   855
         End
         Begin VB.TextBox txtResistance2Min 
            Alignment       =   2  'Center
            Height          =   360
            Left            =   1920
            TabIndex        =   132
...
Dim O, P As String
    ...
    rs("Resistance1Offset") = Format(Val(txtResistanceOffset(0).Text), "0.000")
    rs("Resistance2Offset") = Format(Val(txtResistanceOffset(1).Text), "0")
    rs("Resistance1Min") = Format(Val(txtResistance1Min.Text), "00.000")
    rs("Resistance1Max") = Format(Val(txtResistance1Max.Text), "00.000")
    rs("Resistance2Min") = Format(Val(txtResistance2Min.Text), "0")
    rs("Resistance2Max") = Format(Val(txtResistance2Max.Text), "0")
...
Dim Sql As String
    ...
    txtResistanceOffset(0).Text = Format(Val(rs("Resistance1Offset")), "0.000")
    txtResistanceOffset(1).Text = Format(Val(rs("Resistance2Offset")), "0")
    txtResistance1Min.Text = Format(Val(rs("Resistance1Min")), "00.000")
    txtResistance1Max.Text = Format(Val(rs("Resistance1Max")), "00.000")
    txtResistance2Min.Text = Format(Val(rs("Resistance2Min")), "0")
    txtResistance2Max.Text = Format(Val(rs("Resistance2Max")), "0")
...
If AccessType = "0" Then 'Disable or Hide For Operators
   ...
   Frame4.Visible = False
    ...
    txtResistanceOffset(0).Visible = False
    txtResistanceOffset(1).Visible = False
