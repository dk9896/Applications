...
Begin VB.Form frmsettings 
   ...
   Begin VB.PictureBox Picture1 
      ...
      Begin VB.TextBox txtRevisionNo 
         ...
         Left            =   2160
         TabIndex        =   25
         ToolTipText     =   "Set Drawing Revision No only one degit"
         Top             =   4320
         Width           =   855
      End
      Begin VB.TextBox txtVendorCode 
         ...
         Left            =   2160
         TabIndex        =   23
         ToolTipText     =   "Set Vendor Id of 6 Digit"
         Top             =   3600
         Width           =   3735
      End
      ...
      Begin VB.TextBox txtPartNo 
         ...
         Left            =   2160
         TabIndex        =   18
         ToolTipText     =   "Set Polaris Part No of upto 15 digit"
         Top             =   2880
         Width           =   3735
      End
...
Dim O, P As String
    ...
    End If
        ...
        Rs("PartNo") = Trim(txtPartNo.Text)
        Rs("VendorCode") = Trim(txtVendorCode.Text)
        Rs("RevisionNo") = Trim(txtRevisionNo.Text)
...
Dim Sql As String
    ...
    Rs.Open Sql, Con, adOpenDynamic, adLockOptimistic
        ...
        txtVendorCode.Text = Rs("VendorCode")
        txtRevisionNo.Text = Rs("RevisionNo")
        For j = 0 To 0
...
Private Function CheckValidEntry() As Boolean
    ...
    If ValidLen(6, 6, txtVendorCode) = False Then Exit Function
    'If ValidLen(1, 1, txtlinecode) = False Then Exit Function
    If ValidLen(1, 15, txtPartNo) = False Then Exit Function
