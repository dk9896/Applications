...
If reporttype = 1 Then
   ...
   End If
    ...
    With VSFReport
      ...
      .TextMatrix(Row, 7) = rs("Cavity")
      
    .TextMatrix(Row, 8) = rs("TestVolOn")
    .TextMatrix(Row, 9) = rs("TestVolOff")
    .TextMatrix(Row, 10) = rs("TestCurOn")
    .TextMatrix(Row, 11) = rs("TestCurOff")
    .TextMatrix(Row, 12) = rs("MVDOn")
    .TextMatrix(Row, 13) = rs("MVDOff")
    .TextMatrix(Row, 14) = rs("ContBrkPntOn")
    .TextMatrix(Row, 15) = rs("ContBrkPntOff")
    .TextMatrix(Row, 16) = rs("OpeForceOn")
    .TextMatrix(Row, 17) = rs("OpeForceOff")
'    .TextMatrix(Row, 17) = rs("ContResOn1")
'    .TextMatrix(Row, 18) = rs("ContResOff1")

'    .TextMatrix(Row, 19) = rs("TestVolOn2")
'    .TextMatrix(Row, 20) = rs("TestVolOff2")
'    .TextMatrix(Row, 21) = rs("TestCurOn2")
'    .TextMatrix(Row, 22) = rs("TestCurOff2")
'    .TextMatrix(Row, 23) = rs("MVDOn2")
'    .TextMatrix(Row, 24) = rs("MVDOff2")
'    .TextMatrix(Row, 25) = rs("ContBrkPntOn2")
'    .TextMatrix(Row, 26) = rs("ContBrkPntOff2")
'    .TextMatrix(Row, 27) = rs("OpeForceOn2")
'    .TextMatrix(Row, 28) = rs("OpeForceOff2")
'    .TextMatrix(Row, 29) = rs("ContResOn2")
'    .TextMatrix(Row, 30) = rs("ContResOff2")
'
'    .TextMatrix(Row, 31) = rs("TestVolOn3")
'    .TextMatrix(Row, 32) = rs("TestVolOff3")
'    .TextMatrix(Row, 33) = rs("TestCurOn3")
'    .TextMatrix(Row, 34) = rs("TestCurOff3")
'    .TextMatrix(Row, 35) = rs("MVDOn3")
'    .TextMatrix(Row, 36) = rs("MVDOff3")
'    .TextMatrix(Row, 37) = rs("ContBrkPntOn3")
'    .TextMatrix(Row, 38) = rs("ContBrkPntOff3")
'    .TextMatrix(Row, 39) = rs("OpeForceOn3")
'    .TextMatrix(Row, 40) = rs("OpeForceOff3")
'    .TextMatrix(Row, 41) = rs("ContResOn3")
'    .TextMatrix(Row, 42) = rs("ContResOff3")
'
'    .TextMatrix(Row, 43) = rs("TestVolOn4")
'    .TextMatrix(Row, 44) = rs("TestVolOff4")
'    .TextMatrix(Row, 45) = rs("TestCurOn4")
'    .TextMatrix(Row, 46) = rs("TestCurOff4")
'    .TextMatrix(Row, 47) = rs("MVDOn4")
'    .TextMatrix(Row, 48) = rs("MVDOff4")
'    .TextMatrix(Row, 49) = rs("ContBrkPntOn4")
'    .TextMatrix(Row, 50) = rs("ContBrkPntOff4")
'    .TextMatrix(Row, 51) = rs("OpeForceOn4")
'    .TextMatrix(Row, 52) = rs("OpeForceOff4")
'    .TextMatrix(Row, 53) = rs("ContResOn4")
'    .TextMatrix(Row, 54) = rs("ContResOff4")
     End With
...
'    .TextMatrix(0, 7) = "Cavity 1"
'    .TextMatrix(0, 8) = "Cavity 1"
'    .TextMatrix(0, 9) = "Cavity 1"
'    .TextMatrix(0, 10) = "Cavity 1"
'    .TextMatrix(0, 11) = "Cavity 1"
'    .TextMatrix(0, 12) = "Cavity 1"
'    .TextMatrix(0, 13) = "Cavity 1"
'    .TextMatrix(0, 14) = "Cavity 1"
'    .TextMatrix(0, 15) = "Cavity 1"
'    .TextMatrix(0, 16) = "Cavity 1"
'    .TextMatrix(0, 17) = "Cavity 1"
'    .TextMatrix(0, 18) = "Cavity 1"

    .TextMatrix(0, 8) = "Testing Voltage"
    .TextMatrix(0, 9) = "Testing Voltage"
    .TextMatrix(0, 10) = "Testing Current"
    .TextMatrix(0, 11) = "Testing Current"
    .TextMatrix(0, 12) = "MVD"
    .TextMatrix(0, 13) = "MVD"
    .TextMatrix(0, 14) = "Contact Break Point"
    .TextMatrix(0, 15) = "Contact Break Point"
    .TextMatrix(0, 16) = "Operating Force"
    .TextMatrix(0, 17) = "Operating Force"
    '.TextMatrix(0, 18) = "Contact Resistance"
    '.TextMatrix(0, 19) = "Contact Resistance"

    .TextMatrix(1, 8) = "Off to On"
    .TextMatrix(1, 9) = "On to Off"
    .TextMatrix(1, 10) = "Off to On"
    .TextMatrix(1, 11) = "On to Off"
    .TextMatrix(1, 12) = "Off to On"
    .TextMatrix(1, 13) = "On to Off"
    .TextMatrix(1, 14) = "Off to On"
    .TextMatrix(1, 15) = "On to Off"
    .TextMatrix(1, 16) = "Off to On"
    .TextMatrix(1, 17) = "On to Off"
    '.TextMatrix(1, 17) = "Off to On"
    '.TextMatrix(1, 18) = "On to Off"
