...
On Error GoTo Error
   ...
   If PLcdata(102) = 0 And pulse2 = False Then
        pulse2 = True
        txtScanBarcode.Text = ""
        txtScanBarcode.BackColor = vbWhite
        txtScanBarcode.Locked = False
        txtScanBarcode.SetFocus
   ElseIf PLcdata(102) = 1 And pulse2 = True Then
        pulse2 = False
        PLcdata(202) = 0
   End If
   ...
   ElseIf PLcdata(109) = 1 And pulse1 = True Then
      pulse1 = False
      lblGo.Visible = True
      If txtScanBarcode.Text <> "" Then
        GetCounterValue
        txtOKCounter.Text = Val(txtOKCounter.Text) + 1
        txtProductionCounter.Text = Val(txtProductionCounter.Text) + 1
        SaveReport 1, txtScanBarcode.Text
        PrintLabel JustPrinter1, Trim(txtScanBarcode.Text)
   ...
   ElseIf PLcdata(109) = 2 And pulse1 = True Then
      ...
      SaveReport 2, txtScanBarcode.Text
      SaveCounterValue
   End If
...
Dim j As Integer
    ...
    Set Rs = New ADODB.Recordset
    Rs.Open Sql, Con, adOpenDynamic, adLockOptimistic
    PLcdata(200) = Rs("ModelNo")
    PartCode = Rs("PartCode")
    PLcdata(201) = Val(Rs("PressingTime")) * 10
    PLcdata(205) = 0
    
    PLcdata(205) = PLcdata(205) + &H1 * Val(Rs("Bypass1"))
    PLcdata(205) = PLcdata(205) + &H2 * Val(Rs("Bypass2"))
    PLcdata(205) = PLcdata(205) + &H4 * Val(Rs("Bypass3"))
    PLcdata(205) = PLcdata(205) + &H8 * Val(Rs("Bypass4"))
    PLcdata(205) = PLcdata(205) + &H10 * Val(Rs("Bypass5"))
    PLcdata(205) = PLcdata(205) + &H20 * Val(Rs("Bypass6"))
    PLcdata(205) = PLcdata(205) + &H40 * Val(Rs("Bypass7"))
    PLcdata(205) = PLcdata(205) + &H80 * Val(Rs("Bypass8"))
    PLcdata(205) = PLcdata(205) + &H100 * Val(Rs("Bypass9"))
    PLcdata(205) = PLcdata(205) + &H200 * Val(Rs("Bypass10"))
    PLcdata(205) = PLcdata(205) + &H400 * Val(Rs("Bypass11"))
    PLcdata(205) = PLcdata(205) + &H800 * Val(Rs("Bypass12"))
    PLcdata(205) = PLcdata(205) + &H1000 * Val(Rs("Bypass13"))
...
Dim Sql As String
   ...
   If Rs("Bypass1") = 1 Then
    ScanValidationBypass = True
   Else
    ScanValidationBypass = False
   End If
Exit Sub
Error:
...
If KeyAscii = 13 Then
  ...
  If ScanValidationBypass = False Then
    If CheckBarcodeValidation(txtScanBarcode.Text) = True Then
        PLcdata(202) = 1
